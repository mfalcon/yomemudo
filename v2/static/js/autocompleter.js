...
jQuery.extendIf(usig, {
    ...
    loadJs: function(c, f) {
        if (usig.loadingJs.indexOf(c) < 0) {
            ...
            b.onload = b.onreadystatechange = function() {
                if ((b.readyState && b.readyState !== "complete" && b.readyState !== "loaded") || e) {
                    return false
                }
    ...
    removeCss: function(b) {
        ...
        for (var c = d.length; c >= 0; c--) {
            if (d[c] && d[c].getAttribute("href") != null && d[c].getAttribute("href").indexOf(b) != -1) {
                d[c].parentNode.removeChild(d[c])
            }
        }
    },
...
jQuery.expr[":"].ContainsFilter = function(c, d, b) {
    if (c.innerHTML.indexOf("data-filter") >= 0) {
        var e = c.innerHTML.match(/data-filter\=\"(.*?)\"/)[1].toUpperCase().indexOf(b[3].toUpperCase()) >= 0
    }
...
usig.InputController = (function(b) {
    return function(e, d) {
        ...
        var i = function(k) {
            ...
            if (k.type != "blur" && k.type != "focus" && typeof(g.onKeyUp) == "function") {
                g.onKeyUp(j, h.value)
            }
            if (k.type != "blur" && k.type != "focus" && h.value != c && typeof(g.onChange) == "function") {
                c = h.value;
                g.onChange(h.value)
            }
    ...
    return function(l, f, c) {
        ...
        function H(i, L, K) {
            if (i.descripcion != undefined && i.descripcion != "") {
                return '<li class="acv_op"><a href="#" class="acv_op" name="' + L + '"><span class="tl"/><span class="tr"/><span>' + K(i.toString()) + '</span><span class="clase">(' + i.descripcion + ")</span></a></li>"
            } else {
                return '<li class="acv_op"><a href="#" class="acv_op" name="' + L + '"><span class="tl"/><span class="tr"/><span>' + K(i.toString()) + "</span></a></li>"
            }
        }
    ...
    return function(i, e) {
        ...
        function u(z) {
            ...
            if (x) {
                ...
                x = b('<div id="' + s + '" class="usig_acv">						<div class="header">							<div class="corner"/>							<div class="bar"/>						</div>						<div class="content">' + z + '</div>						<div class="footer">							<div class="corner"/>							<div class="bar"/>						</div>					</div>');
                var A = b(c).offset();
                x.css({
                    position: "absolute",
                    left: A.left + "px",
        ...
        function f(z) {
            if (x) {
                ...
                if (typeof(z) == "string") {
                    ...
                    b("ul.options li:has(a)", x).slice(z, z + 1).addClass("highlight")
                }
            }
        }
        ...
        function n(z) {
            ...
            for (var C = 0; C < F.length; C++) {
                ...
                if (E < 0) {
                    var E = G.toLowerCase().indexOf(F[C].translate("áéíóúüÁÉÍÓÚÜàèìòùÀÈÌÒÙ", "aeiouuAEIOUUaeiouAEIOU").toLowerCase())
                }
                if (E >= 0) {
        ...
        this.show = function(A, z) {
                ...
                if (typeof(F) == "string") {
                    ...
                    if (typeof(p.optionsFormatter) == "function") {
                        ...
                        if (typeof(F.toString) == "function") {
                            C += '<li class="acv_op"><a href="#" class="acv_op" name="' + s + m + '"><span class="tl"/><span class="tr"/><span>' + B(F.toString()) + "</span></a></li>";
                            g[s + m] = F;
                            m++
                        }
                    }
            ...
            if ((z === true || !isNaN(parseInt(z))) && x && b("ul.options li a", x).length > 0) {
                if (m > 1 && d) {
                    d = false;
                    k()
                }
                ...
                if (p.idDiv) {
                    x.html('<div class="content"><ul class="options">' + C + "</ul></div>");
                    x.show()
                } else {
                    u('<ul class="options">' + C + "</ul>")
                }
            }
            b("ul.options li.acv_op", x).mouseover((function(F, E) {
                if (F.target.name) {
                    E(F.target.name)
                } else {
            ...
            b("ul.options li.acv_op", x).mouseout((function(E) {
                if (r) {
                    r = false;
                    k()
                }
            }).createDelegate(this));
            b("ul.options li.acv_op", x).click((function(F) {
                F.preventDefault();
                var G = F.target ? F.target : F.srcElement;
                var E = b(G).parents("a.acv_op").attr("name") || b("a.acv_op", b(G)).attr("name") || b(G).attr("name");
                w(g[E])
            }).createDelegate(this));
            if (p.autoSelect && m == 1) {
                h = 0;
        ...
        this.showMessage = function(z) {
            if (p.idDiv) {
                x.html('<div class="content"><div class="message">' + z + "</div></div>");
                x.show()
            } else {
        ...
        this.keyUp = function(z) {
            ...
            if ((z == y.arrDn || z == y.arrUp) && m > 0) {
                if (x.css("display") != "block") {
                    ...
                    q();
                    h = z == y.arrDn ? (h + 1).constrain(0, m - 1) : (h - 1).constrain(0, m - 1);
                    f(h)
                }
            }
            if (y.enter == z) {
        ...
        this.changeSkin = function(z) {
            usig.removeCss(p.rootUrl + "css/usig.AutoCompleterDialog." + p.skin + ".css");
            p.skin = z;
            usig.loadCss(p.rootUrl + "css/usig.AutoCompleterDialog." + p.skin + ".css")
        };
        this.hide = function() {
            l();
            if (x) {
...
usig.AjaxComponent = (function(b) {
    return jQuery.Class.create({
        init: function(f, c, e) {
            this.name = f;
            var d = e.dataType || (window.location.host == usig.parseUri(c).authority ? "json" : "jsonp");
            this.defaultParams = {
                type: "GET",
                url: c,
                dataType: d
            ...
            function k(n, p) {
                if (n != null && n.readyState != 0 && n.readyState != 4) {
                    ...
                    if (this.opts.maxRetries > i) {
                        ...
                        d = setTimeout(k.createDelegate(this, [o, m]), this.opts.serverTimeout)
                    } else {
                        if (typeof(p.error) == "function") {
                            p.error("Se produjo un error al intentar acceder al servidor: " + p.url)
                        }
                    }
                }
            }
    ...
    usig.Calle = function(b, c, e, d) {
        ...
        this.alturaValida = function(g) {
            if (e instanceof Array) {
                ...
                var f = false;
                for (a in e) {
                    f = f || ((parseInt(e[a][0]) <= parseInt(g)) && (parseInt(e[a][1]) >= parseInt(g)))
                }
                return f
            }
        };
...
if (typeof(usig.Direccion) == "undefined") {
    usig.Direccion = (function(b) {
        return function(c, g) {
            ...
            this.isEqual = function(k) {
                var l = (k instanceof usig.Direccion && (e == k.getTipo()) && ((e == usig.Direccion.CALLE_ALTURA && f.isEqual(k.getCalle()) && i == k.getAltura()) || (e == usig.Direccion.CALLE_Y_CALLE && ((f.isEqual(k.getCalle()) && j.isEqual(k.getCalleCruce())) || (f.isEqual(k.getCalleCruce()) && j.isEqual(k.getCalle()))))));
                return l
            }
        }
    })(jQuery);
    ...
    usig.Direccion.fromObj = function(d) {
        var b = null;
        if (d.tipo != undefined) {
            b = new usig.Direccion(usig.Calle.fromObj(d.calle), (d.tipo == usig.Direccion.CALLE_ALTURA) ? d.altura : usig.Calle.fromObj(d.calle_cruce))
        } else {
    ...
    return usig.AjaxComponent.extend({
        ...
        geoCodificarDireccion: function(d, f, c, e) {
            ...
            if (d.getTipo() == usig.Direccion.CALLE_ALTURA) {
                this.geoCodificarCodigoDeCalleAltura(d.getCalle().codigo, d.getAltura(), f, c, e)
            } else {
                this.geoCodificar2CodigosDeCalle(d.getCalle().codigo, d.getCalleCruce().codigo, f, c)
            }
        },
        geoCodificarCalleAltura: function(f, h, g, c, d) {
            ...
            this.mkRequest(e, this.onSuccess.createDelegate(this, [g], 1), c, this.opts.server + "geocoding/")
        },
        geoCodificarCodigoDeCalleAltura: function(e, h, g, c, d) {
            ...
            this.mkRequest(f, this.onSuccess.createDelegate(this, [g], 1), c, this.opts.server + "geocoding/")
        },
        geoCodificarCalleYCalle: function(d, c, g, e) {
            ...
            this.mkRequest(f, this.onSuccess.createDelegate(this, [g], 1), e, this.opts.server + "geocoding/")
        },
        geoCodificar2CodigosDeCalle: function(g, e, f, c) {
            ...
            this.mkRequest(d, this.onSuccess.createDelegate(this, [f], 1), c, this.opts.server + "geocoding/")
        },
...
usig.GeoCoder.defaults = {
    ...
    server: "https://ws.usig.buenosaires.gob.ar/geocoder/2.2/",
    metodo: undefined
};
if (typeof(usig) == "undefined") {
    usig = {}
...
usig.Inventario = (function(b) {
    return usig.AjaxComponent.extend({
        ...
        getCategorias: function(d, c) {
            this.lastRequest = this.mkRequest({}, d, c, this.opts.server + "getCategorias/")
        },
        getParcelaPorDir: function(d, e, c) {
            this.lastRequest = this.mkRequest({
                cod_calle: d.cod,
                altura: d.alt
            }, e, c, this.opts.server + "getParcela/")
        },
        getDir: function(d, e, c) {
            this.lastRequest = this.mkRequest(d, e, c, this.opts.server + "getDir/")
        },
        getParcela: function(e, d, f, c) {
            this.lastRequest = this.mkRequest(e, f, c, this.opts.server + "getParcela" + d + "/")
        },
        getDatosTransporte: function(d, e, c) {
            this.lastRequest = this.mkRequest(d, e, c, this.opts.server + "getDatosTransporte/")
        },
        buscar: function(j, i, d, c) {
            ...
            function e(k, n) {
                ...
                b.each(k.clasesEncontradas, function(o, p) {
                    m[p.id] = new usig.inventario.Clase(p.id, p.nombre, p.nombreId, p.nombreNorm)
                });
            ...
            if (f.bbox) {
                g.bbox = [f.extent.left, f.extent.bottom, f.extent.right, f.extent.top].join(",")
            }
            ...
            if (f.searchInventario) {
                this.lastRequest = this.mkRequest(g, h, d, this.opts.server + "buscar/")
            }
            if (f.searchEpok) {
                this.lastRequestEpok = this.mkRequest(g, h, d, this.opts.serverEpok + "buscar/")
            }
        },
        getObjeto: function(e, f, c) {
            ...
            if (typeof(g) == "string") {
                this.lastRequestEpok = this.mkRequest({
                    id: g
                }, d.createDelegate(this, [f, e], 1), c, this.opts.serverEpok + "getObjectContent/")
            } else {
                g = parseInt(g);
                if (g > 0) {
                    this.lastRequest = this.mkRequest({
                        id: g
                    }, d.createDelegate(this, [f, e], 1), c, this.opts.server + "getObjectContent/")
                }
            }
        },
        getFeatureInfo: function(d, e, c) {
            this.lastRequest = this.mkRequest(d, e, c, this.opts.server + "getObjectContent/")
        },
        getCloseFeatures: function(d, e, c) {
            this.lastRequest = this.mkRequest(d, e, c, this.opts.server + "objetosCercanos/")
        },
        getGeom: function(c, e, d) {
            this.lastRequest = this.mkRequest({
                id: c
            }, e, d, this.opts.server + "getGeometria/")
        },
        abort: function() {
            if (this.lastRequest) {
...
usig.Inventario.defaults = {
    ...
    server: "https://inventario.usig.buenosaires.gob.ar/publico/",
    //serverEpok: "//epok.buenosaires.gob.ar/",
    serverEpok: "https://epok.buenosaires.gob.ar/",
    dataType: "jsonp",
    searchOptions: {
        start: 0,
        limit: 20,
        ...
        this.fill = function(f) {
            ...
            if (f.direccionAsociada) {
                ...
                if (f.direccionNormalizada && usig.NormalizadorDirecciones) {
                    try {
                        this.direccionAsociada = usig.NormalizadorDirecciones.normalizar(f.direccionNormalizada, 10, true)[0];
...
usig.inventario.Clase.fromObj = function(b) {
    return new usig.inventario.Clase(b.id, b.nombre, b.nombreId, b.nombreNormalizado)
};
if (typeof(usig) == "undefined") {
    usig = {}
}
...
usig.SuggesterLugares = (function(b) {
    return usig.Suggester.extend({
        init: function(c) {
            if (c != undefined) {
                var d = b.extend({}, usig.SuggesterLugares.defaults.searchOptions, c.searchOptions);
                c.searchOpts = d
            }
        ...
        getSuggestions: function(e, g, f) {
            ...
            try {
                this.opts.inventario.buscar(e, g, function() {}, {
                    limit: c
                })
            } catch (d) {
                g(d)
        ...
        getGeoCoding: function(c, d) {
            if (!(c instanceof usig.inventario.Objeto)) {
                ...
                this.opts.inventario.getObjeto(c, function(e) {
    ...
    usig.Direccion = (function(b) {
        return function(c, g) {
            ...
            this.isEqual = function(l) {
                var m = (l instanceof usig.Direccion && (e == l.getTipo()) && ((e == usig.Direccion.CALLE_ALTURA && f.isEqual(l.getCalle()) && j == l.getAltura()) || (e == usig.Direccion.CALLE_Y_CALLE && ((f.isEqual(l.getCalle()) && k.isEqual(l.getCalleCruce())) || (f.isEqual(l.getCalleCruce()) && k.isEqual(l.getCalle()))))));
                return m
            }
        }
    })(jQuery);
...
usig.Callejero = (function(h) {
    ...
    return {
        ...
        buscarPorCodigo: function(u) {
            ...
            if (/^[0-9]+$/.test(u)) {
                ...
                if (t > -1) {
                    ...
                    i = t + 1;
                    while (i < usig.data.Callejero.length && usig.data.Callejero[i][0] == u) {
        ...
        matcheaCalle: function(w, r) {
            var u = [];
            var t = [];
            var s = w.replace(/"/g, "").translate("áéíóúüÁÉÍÓÚÜàèìòùÀÈÌÒÙ", "aeiouuAEIOUUaeiouAEIOU").toUpperCase().trim();
            var v = s.split(" ");
            ...
            if (this.listo()) {
                for (var x = 0; x < usig.data.Callejero.length; x++) {
                    if (f(wordsRE, usig.data.Callejero[x])) {
                        if (!y.test(usig.data.Callejero[x][1]) && usig.data.Callejero[x][3].length != 0) {
                            u.push(new usig.Calle(usig.data.Callejero[x][0], usig.data.Callejero[x][1], usig.data.Callejero[x][3], usig.data.Callejero[x][4]))
                        } else {
                            t.push(new usig.Calle(usig.data.Callejero[x][0], usig.data.Callejero[x][1], usig.data.Callejero[x][3], usig.data.Callejero[x][4]))
                        }
        ...
        tieneTramosComoAv: function(s) {
            ...
            return s.codigo != 0 && (usig.data.Callejero[r - 1][0] == s.codigo || usig.data.Callejero[r + 1][0] == s.codigo)
        },
...
usig.StringDireccion = (function(b) {
    return function(e, d) {
        ...
        this.strCalles = "";
        this.strAltura = "";
        this.strInput = e.replace(/"/g, "").replace(/[\.,\(\)']/g, " ").toUpperCase().trim();
        var j = /[sS][/\\][nN]/;
        ...
        if (this.strInput.length > 0) {
            ...
            if (c.length >= 2) {
                ...
                if (c.length >= 2) {
                    ...
                    this.strCalles = [c[0].replace(" & ", " Y "), c[1].replace(" & ", " Y ")]
                }
            }
        ...
        function g(k) {
            return k.translate(["GELLY Y OBES", "MENENDEZ Y PELAYO", "OLAGUER Y FELIU", "ORTEGA Y GASSET", "PAULA Y RODRIGUEZ", "PAZ Y FIGUEROA", "PI Y MARGALL", "RAMON Y CAJAL", "TORRES Y TENORIO", "TREINTA Y TRES"], ["GELLY & OBES", "MENENDEZ & PELAYO", "OLAGUER & FELIU", "ORTEGA & GASSET", "PAULA & RODRIGUEZ", "PAZ & FIGUEROA", "PI & MARGALL", "RAMON & CAJAL", "TORRES & TENORIO", "TREINTA & TRES"])
        }
...
usig.ErrorCalleInexistenteAEsaAltura = (function(b) {
    return function(d, c, e) {
        ...
        this.getErrorMessage = function() {
            var f = usig.ErrorCalleInexistenteAEsaAltura.defaults.texts.message + "<ul>";
...
usig.ErrorCruceInexistente = (function(b) {
    return function(d, f, c, e) {
        ...
        this.getErrorMessage = function() {
            ...
            g += "<br/>" + usig.ErrorCruceInexistente.defaults.texts.detalleCalle1 + "<ul>";
...
usig.ErrorCalleSinAlturas = function(b) {
    this.toString = function() {
        return usig.ErrorCalleSinAlturas.defaults.texts.message.replace("{calle}", b)
    };
    this.getNombreCalle = function() {
        return b
    };
...
usig.NormalizadorDirecciones = (function(f) {
    ...
    function j(z, A, y) {
        ...
        if (x.length == 0 && c.length > 0) {
            ...
            x = n(x);
            if (x.length == 0) {
                throw (new usig.ErrorCalleInexistenteAEsaAltura(z.strCalles, c, z.strAltura))
            }
        } else {
            if (x.length == 0 && c.length == 0) {
                z.quitarPasajes();
    ...
    function m(x, w) {
        function c(y) {
            y = y.replace(/"/g, "").translate("áéíóúüÁÉÍÓÚÜàèìòùÀÈÌÒÙ", "aeiouuAEIOUUaeiouAEIOU").toUpperCase().trim();
            y = y.split(" ");
            return y
        }
        x = c(x);
        ...
        if (w.length != 0) {
            for (var y = 0; y < w.length; y++) {
                try {
                    ...
                    if (x instanceof usig.ErrorCalleSinAlturas && h.aceptarCallesSinAlturas && A.esAlturaSN(A.strAltura)) {
    ...
    function t(J, I) {
        ...
        for (var C = 0; C < L.length; C++) {
            for (var z = 0; z < K.length; z++) {
                if (L[C].codigo != K[z].codigo && F.indexOf(G(L[C], K[z])) < 0 && L[C].seCruzaCon(K[z]) && K[z].seCruzaCon(L[C])) {
        ...
        if (c.length == 0 && L.length > 0 && K.length > 0) {
            ...
            if (E.indexOf("AV") >= 0 || E.indexOf("AVDA") >= 0 || E.indexOf("AVENIDA") >= 0) {
                var D = f.extend(true, {}, J);
                D.quitarAvsCalle();
                try {
                    var y = t(D, I)
                } catch (H) {
                    throw (new usig.ErrorCruceInexistente(J.strCalles[0], L, J.strCalles[1], K))
                }
                n(y);
            ...
            if (B.indexOf("AV") >= 0 || B.indexOf("AVDA") >= 0 || B.indexOf("AVENIDA") >= 0) {
    ...
    function b(c, w) {
        ...
        while (matcheo = y.exec(c)) {
            ...
            if (res) {
                if (x.length > 0) {
                    if (res.pos == x[x.length - 1].pos && res.match.toString() == x[x.length - 1].match.toString()) {
    ...
    return {
        ...
        init: function(c) {
            ...
            for (var w = 1; w <= h.maxPalabras; w++) {
                re.calleAltura[w] = new RegExp("(\\d+(\\s+(\\w|\\d|á|é|í|ó|ú|ü|ñ|'|`|,|\\.)+){" + w + "})", "gi");
                re.calle[w] = new RegExp("(\\w|\\d|á|é|í|ó|ú|ü|ñ|'|`|,|\\.)+(\\s+(\\w|\\d|á|é|í|ó|ú|ü|ñ|'|`|,|\\.)+){" + (w - 1) + "}", "gi")
            }
